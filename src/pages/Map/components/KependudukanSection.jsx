      ...
      if (grafikData) {
        const {
         ...
         "pendek": Pendek,
          ...
          //PMT
          "weightfaltering": WeightFaltering,
        ...
        "perempuan": Perempuan,
         ...
         "kepadatan": Kepadatan,
          ...
          const stunting = [Bayi, Sangatpendek, Pendek, Stunting, Puskesmas];
          
          const pmt = [WeightFaltering, Underweight, Wasting, Stunted, Bumilkek];
